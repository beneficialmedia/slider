export const calculateThumbPositions = ({ limits, rangeValue1, rangeValue2 }: ICalculateThumbPositions) => {
  ...
  export const calculateInputBackgroundColor = ({ thumbPositions, sliderTrackColor, railColor }: IInputBackgroundColor) => {
    ...
    return `linear-gradient(to right, ${railColor} 0%,
            ...
            ${sliderTrackColor} ${startPosition + 1}%,
            ${sliderTrackColor} ${endPosition}%,
